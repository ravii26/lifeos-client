...
export const PRIORITIES: {
  ...
  { value: "MEDIUM", label: "Medium", dot: "bg-ok", tone: "text-ok", code: "P2", hex: "var(--warn)" },
  { value: "HIGH", label: "High", dot: "bg-warn", tone: "text-warn", code: "P1", hex: "#ff8a8a" },
  { value: "CRITICAL", label: "Critical", dot: "bg-danger", tone: "text-danger", code: "P0", hex: "var(--danger)" },
];
